...
Windows에서는 저장소 루트의 `start_all.bat`을 더블클릭하면 백엔드와 프론트엔드가 함께 실행됩니다.

- 백엔드: `http://127.0.0.1:5000`
- 프론트엔드: `http://localhost:5173`
- 자세한 절차: [LOCAL_RUN.md](./LOCAL_RUN.md)
...
가장 쉬운 방법은 저장소 루트에서 `start_all.bat`을 더블클릭하는 것입니다. 스크립트가 `.env`, Python 가상환경, npm 패키지를 필요한 경우 자동으로 준비하고 프론트엔드를 `http://localhost:5173`에 고정해 실행합니다.

수동 실행이 필요하면 아래 절차를 사용합니다.
...
| 평가 | A / B+ / B / C / D | A |
| 2024 평가 / 2025 평가 / 2026 평가 | A / B+ / B / C / D | A |
| 어학점수 | 숫자만 | 890 |
| 해외개월수 | 숫자만 | 24 |
| 주재원적합도 | 1~100 | 92 |
| 팀장적합도 | 1~100 | 87 |
| 후보목적 | 세미콜론 분리 | 주재원;차기팀장 |
| 사진URL | 이미지 URL | https://example.com/photo.jpg |
| 발령내역 | 세미콜론 분리, 각 건은 날짜\|부서\|직위\|비고 | 2022-01\|품질관리팀\|과장\|승진 |
