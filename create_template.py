...
# Add sample data
sample_data = [
    ["E24017", "김도현", "품질관리팀", "생산/품질", "과장", "5", "2011-03-15", "본사", "kim.dohyun@company.com", 12.4, "A", "A, A, A", "A", "TOEIC", 890, "TOEIC", "중국 주재", "중국", 24, "장기 주재", "품질경영기사", 92, 87, "주재원;차기팀장"],
    ["E21884", "박준호", "영업팀", "영업/마케팅", "차장", "5", "2009-06-10", "본사", "park.junho@company.com", 15.1, "A", "A, A, A", "A", "TOEIC", 930, "TOEIC", "인도 파견", "인도", 18, "해외 파견", "무역영어", 95, 91, "주재원;차기팀장"],
    ["E22615", "윤지훈", "설계팀", "기술/설계", "과장", "4", "2014-07-20", "본사", "yoon.jihun@company.com", 9.4, "B+", "B+, A, A", "A", "TOEIC", 840, "TOEIC", "미국 주재", "미국", 30, "장기 주재", "기계설계기사", 86, 84, "주재원;차기팀장"],
]
...
# Set column widths
column_widths = [12, 10, 12, 12, 10, 6, 12, 10, 15, 10, 6, 12, 6, 10, 8, 8, 12, 8, 10, 10, 12, 10, 10, 15]
...
print("✅ Excel 템플릿 생성 완료: template_candidate_data.xlsx")
